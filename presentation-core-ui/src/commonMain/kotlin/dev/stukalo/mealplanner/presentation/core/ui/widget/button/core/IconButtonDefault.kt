...
interface IconButtonDefault {
    ...
    /**
     * Returns the default [dev.stukalo.mealplanner.presentation.core.ui.widget.button.core.IconButtonSizeSet] configuration for the button.
     *
     * @return A [dev.stukalo.mealplanner.presentation.core.ui.widget.button.core.IconButtonSizeSet] instance representing the default size configuration for the button.
     */
    @Composable
