...
val IconBarcodeScanner: ImageVector
    get() {
        if (_IconBarcodeScanner != null) {
            return _IconBarcodeScanner!!
        }
        _IconBarcodeScanner = ImageVector.Builder(
            name = "IconBarcodeScanner",
            defaultWidth = 32.dp,
            defaultHeight = 32.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _IconBarcodeScanner: ImageVector? = null
