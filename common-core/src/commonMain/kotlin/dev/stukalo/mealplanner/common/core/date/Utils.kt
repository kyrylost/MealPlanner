 ...
 */
fun LocalDate.formatDate(format: DateTimeFormat<LocalDate> = dayMonthYearFormat): String = format.format(this)

/**
 * Parses a String into a LocalDate.
 * Returns null if the string cannot be parsed according to the format.
 */
fun String.parseDate(format: DateTimeFormat<LocalDate> = dayMonthYearFormat): LocalDate? = try {
