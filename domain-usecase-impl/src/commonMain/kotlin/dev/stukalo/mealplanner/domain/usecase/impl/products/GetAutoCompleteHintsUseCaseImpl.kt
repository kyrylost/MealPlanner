...
internal class GetAutoCompleteHintsUseCaseImpl(private val searchRepository: SearchRepository) :
    GetAutoCompleteHintsUseCase {
    override suspend operator fun invoke(query: String): Result<List<String>> = runCatching {
