...
internal class SaveDailyNormUseCaseImpl(private val nutritionRepository: NutritionRepository) : SaveDailyNormUseCase {
    override suspend fun invoke(dailyNorm: DailyNormDomainModel): Result<Unit> =
        nutritionRepository.saveDailyNorm(dailyNorm)
}
