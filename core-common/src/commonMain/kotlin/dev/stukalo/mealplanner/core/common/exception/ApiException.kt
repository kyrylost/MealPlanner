package dev.stukalo.mealplanner.core.common.exception
...
sealed class ApiException(
    ...
    sealed class ClientError(
        ...
        class NotAuthorizedException(requestUrl: String, message: String = "Unauthorized", cause: Throwable? = null) :
            ClientError(requestUrl, 401, message, cause)

        class NotFoundException(requestUrl: String, message: String = "Not Found", cause: Throwable? = null) :
    ...
    sealed class ServerError(
        ...
        class BadGatewayException(requestUrl: String?, message: String = "Bad Gateway", cause: Throwable? = null) :
    ...
    class ConnectionApiException(message: String = "Connection error") : ApiException(message = message)

    class TimeoutApiException(message: String = "Timeout error") : ApiException(message = message)

    class UnknownApiException(httpCode: Int, message: String = "Unknown API error. Code: $httpCode") :
