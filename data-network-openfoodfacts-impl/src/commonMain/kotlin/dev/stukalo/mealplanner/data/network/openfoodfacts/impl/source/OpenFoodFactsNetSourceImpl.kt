...
internal class OpenFoodFactsNetSourceImpl(client: HttpClient) :
    BaseNetSource(client),
    OpenFoodFactsNetSource {
    override suspend fun getProductByBarcode(barcode: String): OFFProductResponseNetModel = performRequest {
