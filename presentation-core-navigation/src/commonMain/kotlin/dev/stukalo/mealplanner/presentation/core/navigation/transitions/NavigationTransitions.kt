...
object NavigationTransitions {
     ...
     */
    fun tabEnter(isRight: Boolean): EnterTransition = slideInHorizontally(
     ...
     */
    fun tabExit(isRight: Boolean): ExitTransition = slideOutHorizontally(
     ...
     */
    val drillDownEnter: EnterTransition =
        slideInVertically(
            initialOffsetY = { it },
            animationSpec = tween(DEFAULT_DURATION)
        ) + fadeIn(animationSpec = tween(DEFAULT_DURATION))
     ...
     */
    val drillDownPopExit: ExitTransition =
        slideOutVertically(
            targetOffsetY = { it },
            animationSpec = tween(DEFAULT_DURATION)
        ) + fadeOut(animationSpec = tween(DEFAULT_DURATION))
