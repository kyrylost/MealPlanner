...
internal class MealTypeMapper : BaseMapper<MealTypeDatabaseModel, MealTypeDomainModel> {
    override fun mapTo(model: MealTypeDatabaseModel): MealTypeDomainModel = when (model) {
    ...
    override fun mapFrom(model: MealTypeDomainModel): MealTypeDatabaseModel = when (model) {
