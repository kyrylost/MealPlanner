...
internal class RecipeMapper(private val edamamRecipeToProductMapper: EdamamRecipeToProductMapper) :
    BaseMapper<EdamamRecipeNetModel, RecipeDomainModel> {
    override fun mapTo(model: EdamamRecipeNetModel): RecipeDomainModel = RecipeDomainModel(
