package dev.stukalo.mealplanner.presentation.core.styling.color.palette.lime
...
/**
 * A lime-themed light color palette.
 */
internal val ColorLimeLight = AppColors(
    brand = BrandColors(
        primary = ColorTokens.Lime500,
        primaryVariant = ColorTokens.Lime600,
        secondary = ColorTokens.Purple900
    ),
    text = TextColors(
